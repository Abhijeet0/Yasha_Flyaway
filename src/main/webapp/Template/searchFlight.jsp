            ...
            <div class="card-header d-flex justify-content-left">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                   <li class="nav-item" role="presentation">
                      <a class="nav-link active links" id="ticket-tab" data-toggle="tab" href="#ticket" role="tab" aria-controls="ticket" aria-selected="true">Flight ticket</a>
                   </li>
                   <li class="nav-item" role="presentation">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="ticket" role="tabpanel" aria-labelledby="ticket-tab">
                        <div class="text-white">
                            <input id="one_way" type="radio" name="tab-group-1" checked /><label for="one_way">One direction</label>
                            <input id="return" type="radio" name="tab-group-1" /><label for="return">Round-Trip</label>                            
                        </div>
                        <div class="tab-content">                            
                            <div class="tab-pane  active" id="tekyon" role="tabpanel" aria-labelledby="tekyon-tab">
                                <form class="needs-validation"  action="Template/foundflights.jsp" method="post">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3 mb-3 text-white">
                                            <label for="validationTooltip02">Departure</label>
                                            <input class="form-control" type="date" id="example-date-input" name="flight_date" required>
                                        </div>
                                        <div class="col-md-3 mb-3 text-white">
                                            <label for="validationTooltip02">Passengers</label>
                                            <select class="browser-default custom-select" required>
                                                <option selected>Select...</option>
                                                <option value="ytskn">Adult</option>
                                                <option value="cck">Child</option>
                                                <option value="bbk">Baby</option>
                                            </select>
                                        </div>
                            ...
                            <div class="tab-pane" id="gidisdonus" role="tabpanel" aria-labelledby="return-tab">
                                <form class="needs-validation" action="Template/foundflights.jsp" method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3 text-white">
                                            <label for="validationTooltip02">Return</label>
                                            <input class="form-control" type="date" id="example-date-input" name="flight_date" required>
                                        </div>
                                        <div class="col-md-3 mb-3 text-white">
                                            <label for="validationTooltip02">Passengers</label>
