                                                ...
                                                <form role="form">
                                                        ...
                                                        <div class="col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="tel" class="form-control" placeholder="CREDIT CARD NUMBER" required/>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-7 col-md-7">
                                                            <div class="form-group">
                                                                <label><span class="hidden-xs">END</span><span class="visible-xs-inline">USE</span> DATE</label>
                                                    ...
                                                    <div class="card-footer">
                                                        <div class="row">
                                                            <div class="col-xs-12">
                                                                <button type="submit" onclick="bas();" class="btn btn-warning btn-lg btn-block">PAYMENT</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
