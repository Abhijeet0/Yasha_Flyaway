	...
	<html>
		<head>
			...
			<link
				...
				rel="stylesheet">
			<link rel="stylesheet"
				href="Assets/css/userpanelstyle.css">
			<title>Profil</title>
		</head>
		<body>
						...
						<div class="row">
							<div class="col-lg-7 col-md-10">
								...
								<p class="text-white mt-0 mb-5">
									Burası senin profil sayfan. Profil
									bilgilerine ve uçuş bilgilerini
					...
					<div class="row">
														...
														<div
															...
															<div
																...
																<div
																	...
																	<label
																		class="form-control-label" for="input-first-name">
																		Ad
																	</label>
																	<input
															...
															<div
																...
																<div
																	class="form-group focused">
																	<label
																		class="form-control-label" for="input-last-name">
																		Soyad
																	</label>
																	<input
														...
														<div
															...
															<div
																...
																<div
																	class="form-group">
																	<label
																		class="form-control-label" for="input-email">
																		E-posta
																		Adresi
																	</label>
																	<input
															...
															<div
																...
																<div
																	class="form-group focused">
																	<label
																		class="form-control-label" for="input-phone">
																		Telefon
																		Numarası
																	</label>
																	<input
																		type="phone" id="input-username"
																		class="form-control form-control-alternative"
						...
						<div class="col-xl-3 order-xl-1">
							<div class="card bg-secondary shadow">
								<div
									class="card-header bg-white border-danger">
									<div
										class="row align-items-center">
										<img src="Assets/user.png"
											height="30px" style="width:30px!important" />
										<a
								...
								<div class="card-body">
									<div class="text-dark-200">
										<ul
											class="navbar-nav nav align-items-lg-start" id="navbarNav">
											<li class="nav-item ">
												<h3
													class="nav-link fas fa-ticket-alt" href="#">
													&nbsp &nbsp Seyahat
													Bilgileri
												</h3>
											</li>
											<li class="nav-item">
												<h3
													class="nav-link fas fa-bullhorn" href="#">
													&nbsp &nbsp
													Kampanyalar
												</h3>
											</li>
											<li class="nav-item">
												<h3
													class="nav-link text-dark fas fa-user" href="#">
													&nbsp &nbsp Üyelik
													Ayarları
												</h3>
											</li>
											<li class="nav-item">
												<a
													class="btn btn-danger text-white" href="index.jsp">
													Ucuz Uçuş Ara
												</a>
											</li>
											...
											<li class="nav-item">
												<br>
												<a>
													DeliceJet ile ilgili
													talep ve sorularınız
													için 0(999) 999 99
													99 no’lu ücretsiz
													çağrı merkezimizi
													arayabilirsiniz.
